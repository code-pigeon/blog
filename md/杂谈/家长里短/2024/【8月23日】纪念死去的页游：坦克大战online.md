...
![图片加载失败：我的坦克玩具们]({{{img_url}}}psc.jpg "我的坦克玩具们")
...
![图片加载失败：大地旅人]({{{img_url}}}eb68b745b290d55d71a36702777c3f48.jpg "eb68b745b290d55d71a36702777c3f48.jpg")
> 大地旅人身上一直会有一圈一圈的光环从头顶往下降，我已经忘记那是什么了，应该是什么被动技能。

这些boss出场时都会说一句台词。
比如角色“鬼舞者”的出场台词是“挺有能耐啊，看来我得亲自出手了！”
![图片加载失败：刀锋女王]({{{img_url}}}565668aa540b6e83bd89267e607edfbd.jpg "565668aa540b6e83bd89267e607edfbd.jpg")

乔巴的出场台词是“你每打我一下，我都记着，最终都会还给你！”
![图片加载失败：防御大帝]({{{img_url}}}90f495eb7157243f70125f2c83dbd2d2.jpg "90f495eb7157243f70125f2c83dbd2d2.jpg")
...
![图片加载失败：禁锢长老]({{{img_url}}}1255147597_4ad0084dcfeb9.jpeg "1255147597_4ad0084dcfeb9.jpeg")

想不起名字的不止它一个，另外还有两个角色我也想了很久没想起来。

一个是玄武。
![图片加载失败：玄武]({{{img_url}}}玄武.png "玄武")
我在网上先找到的却是它的boss名——冰霜战将，然后一股恶心感就来了，它也是肉系的坦克，而且还会放冰弹减你的速。

它的形象有个特点，就是后面有条🐍，当时做手工的时候还一直在想怎么做这条🐍，然后我哥就这么草率地画了一条“🐍”，然后就这么草率地给它接尾巴上了。

一个是火影。
![图片加载失败：火影]({{{img_url}}}火影.png "火影")
火影实在是没什么突出的特点，以至于我看到游戏里的火影时，也不敢确定是不是它。

不同于其它角色，哈雷却始终是个当小弟的命，从来没有当过boss。
![图片加载失败：哈雷]({{{img_url}}}哈雷.png "哈雷")
![图片加载失败：急速突击者]({{{img_url}}}0000529328.JPG "0000529328.JPG")
但它也是我在游戏里最不想遇到的敌军之一，因为它不仅速度快，而且会一股脑往基地跑，咔咔几炮就把基地轰了。

还有一些角色在当时应该算比较新的，既没有成为boss，也没有当小弟。

比如在当时看来很帅气的瞬。
![图片加载失败：瞬]({{{img_url}}}瞬.png "瞬")
做出来的效果感觉也蛮惊艳的。

还有诺亚方舟、阿凡达、蝎子王、金刚狼。
![图片加载失败：诺亚方舟]({{{img_url}}}诺亚方舟.png "诺亚方舟")
![图片加载失败：阿凡达]({{{img_url}}}阿凡达.png "阿凡达")
![图片加载失败：蝎子王]({{{img_url}}}蝎子王.png "蝎子王")
![图片加载失败：金刚狼]({{{img_url}}}金刚狼.png "金刚狼")

最后登场的是我们的新手英雄——绿橄榄。
![图片加载失败：绿橄榄]({{{img_url}}}绿橄榄.png "绿橄榄")
你可能会说，这绿橄榄怎么不绿啊？~~这当然是因为我们对这个陪伴我们最久的新手英雄的私心~~。实际上就是因为我们没有绿色的废纸壳。不过在它的炮台上我们也留下了解释：
![图片加载失败：黄金炮台]({{{img_url}}}IMG_0108.jpg "IMG_0108.jpg")
所以说这是绿橄榄的升级版🤣。

绿橄榄也是小弟来着，昨天在网上看到它的时候，心里就不自觉冒出一个名字——“传说哥”。当时还觉得应该是自己搞串了，但直到后来看到游戏截图我才确信没记错。
![图片加载失败：传说哥]({{{img_url}}}79ebba5108bc5f80ac85d87d9d36523c.jpg "79ebba5108bc5f80ac85d87d9d36523c.jpg")
话说怎么每个游戏里都有一个传说哥。

## 感慨一下
时隔这么多年，再次看到游戏界面时，几乎都要热泪盈眶了。
![图片加载失败：加载界面]({{{img_url}}}0000536409.JPG "0000536409.JPG")
![图片加载失败：游戏界面]({{{img_url}}}0000523408.JPG "0000523408.JPG")
第一次跟着瓦鲁团长一起打敌人。
![图片加载失败：瓦鲁团长]({{{img_url}}}0000536417.JPG "0000536417.JPG")
合成部件的艰辛（我到头来好像也只合成了一个黄色的，剩下的都是比较低级的蓝色绿色和白色）。
![图片加载失败：部件]({{{img_url}}}9dbdaf41c635abc4e31330935d29c276.jpg "9dbdaf41c635abc4e31330935d29c276.jpg")
打坑爹关卡时的无奈。
![图片加载失败：坑爹关卡]({{{img_url}}}0000529330.JPG "0000529330.JPG")

昨天在回忆猛鬼的名字的时候，突然想起来我在很久之前给坦克们拍过“写真”，把它们都放在了QQ空间里。一看时间，已经是遥远的2013年。
![图片加载失败：2013年上传的照片]({{{img_url}}}Snipaste_2024-08-23_17-26-04.png "Snipaste_2024-08-23_17-26-04.png")

时至今日，游戏早已悄悄地停了服，那些放在箱子里的手工坦克，被我翻开的次数也越来越少，身上全都落满了灰。

诺亚方舟的桨已经七零八落。
![图片加载失败：老年诺亚方舟]({{{img_url}}}IMG_0104.jpg "老年诺亚方舟")

霸王龙更是几乎肢解了。
![图片加载失败：肢解的霸王龙]({{{img_url}}}IMG_0105.jpg "肢解的霸王龙")


不知啥时起也不知为啥，我再没点开这个游戏，从那之后，就再也没有机会点开了。
![图片加载失败]({{{img_url}}}cede49594efd021afc2e7a3da3c55c8f.jpg "cede49594efd021afc2e7a3da3c55c8f.jpg")
