...
![更改图标]({{{img_url}}}Snipaste_2024-07-18_10-08-07.png "Snipaste_2024-07-18_10-08-07.png")

点击“浏览”，然后找到我们编译好的`icon.dll`，在下面的选择框中就会出现我们编译进去的图标。
![选择图标]({{{img_url}}}Snipaste_2024-07-18_10-18-51.png "Snipaste_2024-07-18_10-18-51.png")
