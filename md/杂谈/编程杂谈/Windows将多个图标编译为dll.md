---
title: 'Windows将多个图标编译为dll'
date: '24-07-18 09:52'
updated: '24-07-18 10:21'
---
...
<img data-url="{{image_table.Snipaste_2024-07-18_10-08-07}}" title="Snipaste_2024-07-18_10-08-07" alt="图片加载失败：更改图标"/>

点击“浏览”，然后找到我们编译好的`icon.dll`，在下面的选择框中就会出现我们编译进去的图标。
<img data-url="{{image_table.Snipaste_2024-07-18_10-18-51}}" title="Snipaste_2024-07-18_10-18-51" alt="图片加载失败：点击图标"/>
